        ...
        ">        
            <div style="
                ...
                <p style="
                    ...
                    font-size: 14px;
                    margin-bottom: 0;
                ">Shenzhen RAKwireless Technology Co., Ltd.</p>
                <p style="
                    font-size:11px;
                    margin-top:5px;">
                    Room 506, Bldg B, New Compark, Pingshan First Road, Taoyuan Street, Nanshan District, Shenzhen, Guandong Province, The People's Republic of China</p>
            </div>
            <div style="width: 40%;display:flex;flex-direction:column;align-items:flex-end; justify-items: center;">
                
                <div style="margin-top:14px">
                    <span style="color:#888888;font-size: 18px;">www.<span style="color:#006AC6;"><b>RAK</b>wireless.com</span></span>
                    <div style="
                    ...
                    <span style="padding-left: 15px; font-size: 12px;">+86-755-86108311</span>
                </div>
                <div style="
                    display:flex; align-items:center; margin-top:5px;">
                    ...
                    <span style="padding-left: 15px; font-size: 12px;">inquiry@<span style="font-weight:bold;">RAK</span>wireless.com</span>
